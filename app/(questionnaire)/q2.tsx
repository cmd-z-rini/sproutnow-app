...
const OPTIONS = [
  {
    id: 'helicopter',
    title: '🌱 The Helicopter Parent',
    subtitle: '(I check on them every day)',
  },
  {
    id: 'weekend',
    title: '☕ The Weekend Warrior',
    subtitle: '(I have time once a week)',
  },
  {
    id: 'survivor',
    title: '🌵 The Survivor',
    subtitle: '(I forget they exist until they look sad)',
  },
];
    ...
    <ImageBackground source={bgImage} style={{ flex: 1, width: '100%', height: '100%' }} resizeMode="cover">
      <LinearGradient colors={[...GLASS_GRADIENT]} style={{ flex: 1 }}>
        ...
        <Text style={styles.title}>
          What{'\u2019'}s your plant parenting style?
        </Text>
