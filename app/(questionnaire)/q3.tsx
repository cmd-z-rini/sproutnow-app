...
const OPTIONS = [
  { id: 'sun', title: '☀️ Sun-Drenched', subtitle: '(Lots of direct sun)' },
  { id: 'bright', title: '⛅ Bright & Gentler', subtitle: '(Indirect or filtered light)' },
  { id: 'cave', title: '🌙 Cave Dweller', subtitle: '(Low light, north-facing)' },
];
      ...
      <LinearGradient colors={[...GLASS_GRADIENT]} style={{ flex: 1 }}>
        <BlurView intensity={47} tint="default" style={{ flex: 1 }}>
          <View style={[styles.content, { flex: 1, backgroundColor: 'transparent' }]}>
            ...
            <Text style={styles.title}>Describe your indoor jungle{'\u2019'}s lighting.</Text>
